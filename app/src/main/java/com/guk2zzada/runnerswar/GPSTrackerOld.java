...
public class GPSTrackerOld extends Service implements LocationListener {
    ...
    public GPSTrackerOld(Context context, Handler handler) {
    ...
    public double getDistance() {
        ...
        locationB.setLatitude(getLatitude());
        locationB.setLongitude(getLongitude());
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(PlayMultiActivity.RENEW_GPS);
    ...
    private void sendString(String str){
        ...
        msg.what = PlayMultiActivity.SEND_PRINT;
    ...
    private void sendLatLng(double lat, double lng) {
        ...
        Message msg = mHandler.obtainMessage();
        msg.what = PlayMultiActivity.SEND_LATLNG;
        msg.setData(data);
        mHandler.sendMessage(msg);
