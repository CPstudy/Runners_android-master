...
public class AWSLoginModel {
    ...
    private final String ATTR_PICTURE = "picture";
    ...
    public void registerUser(String userName, String userEmail, String userPassword) {
        ...
        userAttributes.addAttribute(ATTR_PICTURE, "ddd");
        userAttributes.addAttribute(ATTR_GENDER, "male");
        userAttributes.addAttribute("custom:height", "235");
