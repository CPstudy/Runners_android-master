...
public class Login2Activity extends AppCompatActivity implements View.OnClickListener, AWSLoginHandler {
    ...
    public void onRegisterSuccess(boolean mustConfirmToComplete) {
        if (mustConfirmToComplete) {
            Toast.makeText(Login2Activity.this, "Almost done! Confirm code to complete registration", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(Login2Activity.this, "Registered! Login Now!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onSignInSuccess() {
        Login2Activity.this.startActivity(new Intent(Login2Activity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
    }
    ...
    public void onFailure(int process, Exception exception) {
        ...
        Toast.makeText(Login2Activity.this, whatProcess + exception.getMessage(), Toast.LENGTH_LONG).show();
    }
